...
namespace RosMessageTypes.Ur
{
    ...
    {
        public const string k_RosMessageName = "ur_msgs/Position";
        ...
        public PositionMsg(string name, double[] joints, NiryoOne.RPYMsg rpy, Geometry.PointMsg point, Geometry.QuaternionMsg quaternion)
        {
            this.name = name;
            this.joints = joints;
            this.rpy = rpy;
