...
namespace RosMessageTypes.Ur
{
    ...
    {
        public const string k_RosMessageName = "ur_msgs/Tool";
        public override string RosMessageName => k_RosMessageName;

        //  goal
        public NiryoOne.ToolCommandMsg cmd;

        public ToolGoal()
        {
            this.cmd = new NiryoOne.ToolCommandMsg();
        }

        public ToolGoal(NiryoOne.ToolCommandMsg cmd)
        {
            this.cmd = cmd;
        }
        ...
        {
            this.cmd = NiryoOne.ToolCommandMsg.Deserialize(deserializer);
        }
